	...
	render() {
		...
		return (
			<div className="Home Container">
				<Row>
					<Col span={24} className={styles.backred}>
						{" "}
					</Col>
					<img
						src={
					...
					<Col span={12}>
						...
						<Row>
							{professional.user.professions.map(prof => {
								return <div>{prof.profession.title}</div>;
							})}
						</Row>
					</Col>
				</Row>
				...
				<Row>
					{comments.comments ? (
						<Col span={24}>
							<div className={styles.title}>نظر مشتریان</div>
